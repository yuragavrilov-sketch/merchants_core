...
@RestController
@RequestMapping("/internal/v1/admin/merchants")
@Tag(name = "Internal Admin Merchants", description = "Read-only merchant queries for Admin BFF")
@Validated
public class InternalAdminMerchantController {

    private final MerchantService merchantService;

    public InternalAdminMerchantController(MerchantService merchantService) {
        this.merchantService = merchantService;
    }

    @GetMapping
    @Operation(summary = "Get merchants list for Admin BFF")
    ...
    @Operation(summary = "Get merchant by id for Admin BFF")
