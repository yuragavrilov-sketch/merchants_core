...
rem
rem  GitHub stays the source of truth; corp is a downstream mirror (both default to `master`).
rem
...
rem      push-to-corp.bat https://git.tkbbank.ru/tkbpay/.../merchants_core.git
rem
